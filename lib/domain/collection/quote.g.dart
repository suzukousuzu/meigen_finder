...
const QuoteSchema = Schema(
  ...
  properties: {
    ...
    r'emotionalType': PropertySchema(
      ...
      type: IsarType.byte,
      enumMap: _QuoteemotionalTypeEnumValueMap,
    ),
    r'id': PropertySchema(
      id: 2,
      name: r'id',
...
Quote _quoteDeserialize(
  ...
  object.emotionalType =
      _QuoteemotionalTypeValueEnumMap[reader.readByteOrNull(offsets[1])] ??
...
P _quoteDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (_QuoteemotionalTypeValueEnumMap[reader.readByteOrNull(offset)] ??
...
const _QuoteemotionalTypeEnumValueMap = {
  'superHappy': 0,
  'somewhatHappy': 1,
  'normal': 2,
  'somewhatSad': 3,
...
const _QuoteemotionalTypeValueEnumMap = {
...
extension QuoteQueryFilter on QueryBuilder<Quote, Quote, QFilterCondition> {
  ...
  QueryBuilder<Quote, Quote, QAfterFilterCondition> emotionalTypeEqualTo(
      EmotionalType value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Quote, Quote, QAfterFilterCondition> emotionalTypeGreaterThan(
    EmotionalType value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Quote, Quote, QAfterFilterCondition> emotionalTypeLessThan(
    EmotionalType value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Quote, Quote, QAfterFilterCondition> emotionalTypeBetween(
    EmotionalType lower,
    EmotionalType upper, {
    bool includeLower = true,
    bool includeUpper = true,
