...
abstract class $QuoteCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String? author, String quote, String category});
}
...
class _$_Quote implements _Quote {
  ...
  @override
  String toString() {
    return 'Quote(id: $id, author: $author, quote: $quote, category: $category)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, author, quote, category);
...
abstract class _Quote implements Quote {
  const factory _Quote(
      ...
      required final String category}) = _$_Quote;
